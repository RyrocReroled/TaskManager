...
@dso_cache = dso_local local_unnamed_addr global [540 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 108129166, ; hash 0x671eb8e, from name: aot-TaskReminder.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 857010065, ; hash 0x3314ef91, from name: aot-TaskReminder
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TaskReminder.dll.so
		ptr null; void* handle (0x0)
	}, ; 103
	...
	%struct.DSOCacheEntry {
		i64 1927626755, ; hash 0x72e54003, from name: libaot-TaskReminder.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TaskReminder.dll.so
		ptr null; void* handle (0x0)
	}, ; 233
	...
	%struct.DSOCacheEntry {
		i64 3287063031, ; hash 0xc3ec99f7, from name: TaskReminder.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TaskReminder.dll.so
		ptr null; void* handle (0x0)
	}, ; 427
	...
	%struct.DSOCacheEntry {
		i64 4121904700, ; hash 0xf5af463c, from name: libaot-TaskReminder
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TaskReminder.dll.so
		ptr null; void* handle (0x0)
	}, ; 518
	...
	%struct.DSOCacheEntry {
		i64 4169816574, ; hash 0xf88a59fe, from name: TaskReminder
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TaskReminder.dll.so
		ptr null; void* handle (0x0)
	}, ; 528
